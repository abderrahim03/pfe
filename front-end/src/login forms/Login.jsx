   ...
   const styles = {
    ...
    return (
        <div className='2xl:ml-80'>
            ...
            <form className='mx-40 pt-52  pb-28 2xl:mx-80'>
            <div class="grid mt-24  md:grid-cols-2">
    </div>
    <div class="mb-6">
    ...
    <div class="flex items-start mb-6">
        ...
        <label for="remember" class="ml-2 text-sm font-medium text-gray-100 dark:text-gray-300">Remember me</label>
    </div>
    <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Login</button>
    <div class="grid gap-6 mb-48 md:grid-cols-2">
    </div>
</form>
